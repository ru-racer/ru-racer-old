...
tic
plot(x1,y1,'b',x2,y2,'b',radiu_out*cos(c4)-0.8382*10^(3),radiu_out*sin(c4)+length,'r'...
    ,radiu_out*cos(c3)-0.8382*10^(3),radiu_out*sin(c3),'r',...
    radiu_in*cos(c2)-0.8382*10^(3),radiu_in*sin(c2)+length,'b'...
    ,radiu_in*cos(c1)-0.8382*10^(3),radiu_in*sin(c1),'b')
   axis equal
   a=toc